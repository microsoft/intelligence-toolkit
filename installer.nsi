...
Section "!${PRODUCT_NAME}" sec_app
  ...
  IfErrors 0 +3 ; Jump to the next instruction if no error
    MessageBox MB_ICONSTOP "Installation failed: Please close the running application before installing ${PRODUCT_NAME}." /SD IDOK IDOK
    Quit ; T
  ClearErrors
